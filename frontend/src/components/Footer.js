      ...
      <div className="container-w py-14 lg:py-20">
            ...
            <ul className="space-y-3">
              <li>
                <a href={LINKS.whatsapp} target="_blank" rel="noopener noreferrer" data-testid="footer-whatsapp" className="inline-flex items-center gap-2.5 text-sm text-[var(--w-chrome-300)] hover:text-white transition-colors">
                  <MessageCircle size={16} className="text-[#25D366]" /> WhatsApp {BUSINESS.phoneDisplay}
                </a>
              </li>
              <li>
              ...
              <li>
                <a href={LINKS.email} data-testid="footer-email" className="inline-flex items-center gap-2.5 text-sm text-[var(--w-chrome-300)] hover:text-white transition-colors break-all">
                  <Mail size={16} /> {BUSINESS.email}
                </a>
              </li>
              <li>
                <a href={LINKS.google} target="_blank" rel="noopener noreferrer" data-testid="footer-google" className="inline-flex items-center gap-2.5 text-sm text-[var(--w-chrome-300)] hover:text-white transition-colors">
        ...
        <div className="mt-10 pt-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-5 text-xs text-white/40">
            <Link to="/contact#policies" className="hover:text-white/70 transition-colors" data-testid="footer-policies">Policies</Link>
